...
export class UserCreateContract implements Contract{
    ...
    validate(model: any): boolean {
        ...
        flunt.isRequired(model.name, "Informe um nome de usuário correto.")
        ...
        flunt.isRequired(model.password, "Informe uma senha correta.")
        ...
        flunt.isRequired(model.email, "E-mail não pode ser nulo.")
        ...
        flunt.isRequired(model.number, "Informe um número correto.")
